...
SELECT created_at, client_id, category, token_hash, redirect_uri, user_id, scopes, data, expires, used, code_challenge FROM oauth WHERE category = ? AND token_hash = ? AND expires > ?3
`
